...
public class MovieConstant {
    ...
    public static final String STRING_ENV_MEGAPELIS_TMDB_HOST_MOVIE_BY_ID_ALL_IMAGES_NAME = "MEGAPELIS_TMDB_HOST_MOVIE_BY_ID_ALL_IMAGES";
    public static final String STRING_ENV_MEGAPELIS_TMDB_HOST_MOVIE_BY_ID_ALL_VIDEO_NAME = "MEGAPELIS_TMDB_HOST_MOVIE_BY_ID_ALL_VIDEO";
    public static final String STRING_ENV_MEGAPELIS_TMDB_HOST_MOVIE_POPULAR_NAME = "MEGAPELIS_TMDB_HOST_MOVIE_POPULAR";
    public static final String STRING_ENV_MEGAPELIS_TMDB_KEY_NAME = "MEGAPELIS_TMDB_KEY";

    // SERVICIO
    public static final String STRING_SERVICE_NAME = "MovieTMDB";
